...
export const getMainMarkup = (results: Trip[]) => html` <div class="layout">
    <div
      class="list"
        ...
        return html` <div class="item">
          ...
          <div class="content">
            ...
            <span class="description"
              ...
              ${duration_h > 0 ? `${duration_h}h ` : ""}${duration_min}min —
              ${trip.average_speed}km/h average</span
            >
...
export const getHalfHorizontalMarkup = () =>
  html`<div class="view view--half_horizontal">Your content</div>`;

export const getHalfVerticalMarkup = () =>
  html`<div class="view view--half_vertical">Your content</div>`;

export const getQuadrantMarkup = (total_distance: number) =>
  html`<div class="view view--quadrant">${total_distance}</div>`;
